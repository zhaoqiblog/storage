    ...
    <div class="contentWrap">
    	...
    	<div class="storeSelect" style="padding-bottom: 48px;">
      		<div class="wipeList" style="margin-top: 0;">
		          	...
		          	<goods-info-item 
									v-for="(item,index) in goodsToMallSeleData.allGoods" 
...
//  	tablist:[{name:"散货商品",value:0,index:1},{name:"整件商品",value:0,index:2}],
  ...
  mounted(){
		this.goodsToMallSeleData.allGoods.forEach((e)=>{
			e.type="text"
		})
  },
  methods: {
...
//  }
     gotosuccess(){
     	let lists=[]
     	this.goodsToMallSeleData.allGoods.map(e=>{
...
//        })
     		...
     		this.$router.push({path:"/fail",query:{text:'服务器错误，上架失败，请重试！',title:'商品上架',path:'/scanEntry?key=goodsToMall'}})
     	})
    }
  }
}

		...
		<div class="scroll-content pre-content pre-content-pic" ref="scrollWrap">
			...
			<div class="concat-list-wrap">
				<div>
					...
					<!--货位上有商品时，正常情况-->
					<div v-if="removeResult &&!removeResult.rightWarehouseCode">
						<!--<p>22222</p>-->
					<pic-exchange-item 
						:data='removeResult'
						rightTxt="已更新"
...
<script>
	...
	export default {
		...
		created() {
			...
			this.dataobj.leftWarehouseCode = this.dataobj.rightWarehouseCode?(this.dataobj.leftWarehouseCode.substr(0,2)+'-'+this.dataobj.leftWarehouseCode.substr(2,2)+"-"+this.dataobj.leftWarehouseCode.substr(4)):''
			this.dataobj.rightWarehouseCode = this.dataobj.rightWarehouseCode ? (this.dataobj.rightWarehouseCode.substr(0,2)+'-'+this.dataobj.rightWarehouseCode.substr(2,2)+"-"+this.dataobj.rightWarehouseCode.substr(4)):''
